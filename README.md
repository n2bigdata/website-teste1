...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/website-teste1)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/website-teste1
```

A live public deployment of this template is available at [https://website-teste1.templates.workers.dev](https://website-teste1.templates.workers.dev)
